              ...
              { !esSubsanado &&
                <Paper elevation={0} className={classes.message}>
                  <Grid container spacing={2}>
                    <Grid item xs={12}>Tu trámite ha finalizado con exito. Revisa los certificados emitidos.</Grid>
                  </Grid>
                </Paper>
              }
              </Typography>
          ...
          <Grid item xs={12} md={8}>
            ...
            { esSubsanado &&
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={3}><Button variant="outlined" color="primary" component={RouterLink} to="/pic/tramites/tramite-1/gestion-2">AGUARDAR</Button></Grid>
                </Grid>
              </Paper>
              }
        ...
        <Grid container>
          <Grid item xs={12} md={8}>
            <Typography variant="body1">
              ...
              <Paper elevation={0} className={classes.action}>
                <Grid container spacing={2}>
                  <Grid item xs={9}>Permiso de estacionamiento</Grid>
              ...
              <Paper elevation={0} className={classes.action}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={3}><Button variant="outlined" color="primary" component={RouterLink} to="/pic/tramites/tramite-1/gestion-2">VER</Button></Grid>
                </Grid>
              </Paper>
