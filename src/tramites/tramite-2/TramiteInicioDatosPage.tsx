...
function TramiteInicioDatosPage1(props: any) {
    ...
    return (
        <Container className={classes.container}>
          ...
          <Paper className={classes.paper}>
              <p>
                <Button variant="contained" component={RouterLink} to="/pic/web/tramite-2">ANTERIOR</Button>&nbsp;&nbsp;&nbsp;&nbsp;
                <Button color="primary" variant="contained" component={RouterLink} to="/pic/tramites/tramite-2/inicio-confirmacion">SIGUIENTE</Button>
              </p>
          </Paper>
